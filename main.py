...
# Cheah Cher Kiang's Part Start Here
...
# Desmond Chong Soon Chuen's Part Start Here
...
# Chan Hoong Kai's Part Start Here
...
# Chu Wei Zheng's Part Start Here
...
if __name__ == '__main__':
    #if use visual studio code run, use code below
    #app.run(debug=True)
    #if deploy in ec2 instance, use code below
